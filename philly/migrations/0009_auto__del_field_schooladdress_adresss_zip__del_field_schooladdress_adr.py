...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SchoolAddress.adresss_zip'
        db.delete_column('philly_schooladdress', 'adresss_zip')

        # Deleting field 'SchoolAddress.adresss_street'
        db.delete_column('philly_schooladdress', 'adresss_street')

        # Adding field 'SchoolAddress.address_street'
        db.add_column('philly_schooladdress', 'address_street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'SchoolAddress.address_zip'
        db.add_column('philly_schooladdress', 'address_zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SchoolAddress.adresss_zip'
        db.add_column('philly_schooladdress', 'adresss_zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'SchoolAddress.adresss_street'
        db.add_column('philly_schooladdress', 'adresss_street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'SchoolAddress.address_street'
        db.delete_column('philly_schooladdress', 'address_street')

        # Deleting field 'SchoolAddress.address_zip'
        db.delete_column('philly_schooladdress', 'address_zip')
